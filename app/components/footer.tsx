      ...
      <footer className="bg-stone-800 text-stone-300 mt-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
          <div className="flex justify-center content-center">
            <Image src={`${process.env.NODE_ENV === "production" ? "/meraih-pengasih-margosari" : ""}/images/PNG_LOGO_PENGASIH.png`} alt="University Logo" className="h-7 w-7 mx-10" width={500} height={500} />
